  ...
  namespace OilPaintAsset
  {
    ...
    public static class EditorHelper
    {
      ...
      static EditorHelper()
      {
        ...
        defaultAnimationCurve = new AnimationCurve(new Keyframe(0.0f, 1.0f, 0.0f, 0.0f), new Keyframe(1.0f, 0.0f, 0.0f, 0.0f));
      }
      ...
      public static AnimationCurve Curve(string label, string tooltip, AnimationCurve value)
      {
        EditorGUILayout.BeginHorizontal();
        {
          ...
          if (ResetButton(defaultAnimationCurve) == true)
            value = defaultAnimationCurve;
        }
        EditorGUILayout.EndHorizontal();
      ...
      {
        return Vector3(label, value, resetValue);
      }
